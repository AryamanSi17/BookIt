    ...
    if (state.user) {
      ...
      return (
        <>
          ...
          <Link to="/logout">
            <button className="focus:outline-none lg:text-lg lg:font-bold focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700  md:block bg-transparent transition duration-150 ease-in-out hover:bg-gray-200 rounded border border-indigo-700 text-yellow-700  px-8 py-1 sm:py-3 text-sm">Logout</button>
          </Link>
        </>
      )
    } else {
      ...
      return (
        ...
        <>
          ...
          <Link to="/login">
            <button className="focus:outline-none lg:text-lg font-bold focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700  md:block bg-transparent transition duration-150 ease-in-out hover:bg-gray-200 rounded border border-indigo-700 text-yellow-700  px-8 py-1 sm:py-3 text-sm">Sign In / Sign Up</button>
          </Link>
          {/* <button className="focus:outline-none lg:text-lg lg:font-bold focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hidden md:block bg-transparent transition duration-150 ease-in-out hover:bg-gray-200 rounded border border-indigo-700 text-yellow-700  sm:px-8 py-1 sm:py-3 text-sm">Sign In</button> */}
  ...
  return (<>
    ...
    <nav className="w-full border-b bg-black">
      <div className="py-5 md:py-0 container mx-auto px-6 flex items-center justify-between">
        ...
        <div>
          <button onClick={toggleMenu} className="sm:block md:hidden text-gray-50 hover:text-yellow-500 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500">
          ...
          <div id="menu" className="md:block lg:block hidden">
            ...
            <ul onClick={toggleMenu} className="flex text-3xl md:text-base items-center py-10 md:flex flex-col md:flex-row justify-center fixed md:relative top-0 bottom-0 left-0 right-0 bg-white   md:bg-transparent z-20">
              ...
              <li className="text-gray-50 hover:text-yellow-500 cursor-pointer text-base lg:text-lg pt-10 md:pt-0">
                <Link to="/">Home</Link>
              </li>


              <li className="text-gray-50 hover:text-yellow-500 cursor-pointer text-base lg:text-lg pt-10 md:pt-0 md:ml-5 lg:ml-10">
